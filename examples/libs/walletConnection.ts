...
import { createStarkSigner, WalletConnection,generateLegacyStarkPrivateKey } from '@imtbl/core-sdk';
...
export const generateWalletConnection = async (
  ...
  /*const userStarkKey = await generateLegacyStarkPrivateKey(ethSigner);
  console.log(userStarkKey);*/
